<?xml version="1.0" encoding="UTF-8"?>
    ...
    <xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:variable name="xmlDocuments" select="collection(concat('file:/home/floriane/Documents/PaulPipeline/fgTEIpipeLine/data/', $fileName, '/?select=?*.xml;recurse=yes'))"/>
        ...
        <xsl:template match="/" >
            ...
            <xsl:text>"file:/home/floriane/Documents/PaulPipeline/fgTEIpipeLine/odd-setaf-rw-FG.rng" type="application/xml" schematypens="http://relaxng.org/ns/structure/1.0"</xsl:text>
        </xsl:processing-instruction>
            <xsl:processing-instruction name="xml-model">
            <xsl:text>"file:/home/floriane/Documents/PaulPipeline/fgTEIpipeLine/odd-setaf-rw-FG.rng" type="application/xml" schematypens="http://purl.oclc.org/dsdl/schematron"</xsl:text>
        </xsl:processing-instruction>
